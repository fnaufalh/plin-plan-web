	...
	<div class="content">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="ganti-password.php" class="sidebar-active">Ganti Password</a>
                </li>
                <li>
                ...
                <legend>
                    ...
                    <table class="general">
                        <tr>
                            ...
                            <td><input class="control-innput" type="password" name="old-pass" value="load dari database"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="control-innput" type="password" name="nohp" /></td>
                        </tr>
